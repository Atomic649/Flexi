...
import { View, StyleSheet, Image, Linking, Platform, TouchableOpacity } from 'react-native';
          ...
          <View style={styles.buttonContainer}>
            ...
            >
              ...
              <View style={styles.buttonTextContainer}>
                <CustomText style={[styles.storeButtonSmallText, { color: buttonTextColor }]}>
                  {t('mobileWeb.appStore.download')}
                </CustomText>
                <CustomText weight="semibold" style={[styles.storeButtonText, { color: buttonTextColor }]}>
                  {t('mobileWeb.appStore.title')}
                </CustomText>
                <CustomText style={[styles.comingSoon, { color: buttonTextColor }]}>
            ...
            >
              <Ionicons name="logo-google-playstore" size={24} color={buttonTextColor} />
              <View style={styles.buttonTextContainer}>
                <CustomText style={[styles.storeButtonSmallText, { color: buttonTextColor }]}>

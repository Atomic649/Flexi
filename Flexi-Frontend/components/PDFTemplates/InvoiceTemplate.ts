        ...
        <div class="invoice-container">
          ...
          <div class="invoice-header">
            <div class="company-logo-section" style="display: flex; flex-direction: row; align-items: center; gap: 12px;">
              ...
              <div>
                <h1 style="margin: 0;">${t("print.invoice")}</h1>
            ...
            <div class="invoice-meta" style="display: flex; flex-direction: column; align-items: flex-end; justify-content: flex-end;">
              <div class="invoice-number"><span class="bill-label">${t(
                ...
                <p style="margin-top: 1px;">${(() => {
                  const d = new Date(invoice.invoiceAt || invoice.purchaseAt);
          ...
          <div class="terms-summary-container" style="display: flex; gap: 20px; margin-bottom: 20px;">
            ...
            <div class="terms-section" style="flex: 1; width: 50%;">
              <div style="padding:10px 14px; border:1px dashed #ccc; border-radius:6px; background:#f9f9f9;">
                ...
                ${invoice.remark ? `<div style="padding:4px 0; font-size:12px; border-bottom:1px solid #f0f0f0; font-style:italic; color:#555;">${formatTerms(invoice.remark)}</div>` : ""}
                ${invoice.priceValid ? `${(() => {
              ...
              <div class="summary-table">
                ...
                ${(() => {
                  ...
                  return `<div class="summary-row total" style="margin-top:6px; padding-top:6px; border-top:1px dashed var(--brand-color);">
                        <span class="summary-label">${t("print.splitPayment")} ${t("print.installmentNo")} ${no} (${parseFloat(Number(invoice.splitPercent).toFixed(2))}%)</span>
...
<div class="signature-date">${t("print.date")}: ${formatDate(
    invoice.invoiceAt || invoice.purchaseAt,
  )}</div>
